...
def do_deploy(archive_path):
    ...
    # Uncompress the archive to the folder /data/web_static/releases/<archive basename>
    ...
    # Move the contents of the uncompressed archive to /data/web_static/releases/<archive basename>/
